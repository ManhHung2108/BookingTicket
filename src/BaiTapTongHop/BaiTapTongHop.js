...
export default function BaiTapTongHop() {
    //lấy ra mảng danh mục không trùng lặp
        ...
        <div>
            ...
            <div className="grid grid-cols-6">
                ...
                <section className="text-gray-600 body-font col-span-5">
                    <h3 className="text-center text-purple-500 text-5xl font-bold mt-5">
                        Menu
                    </h3>
                                    ...
                                    >
                                        <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                            ...
                                            <div className="text-center leading-none flex justify-end absolute bottom-0 left-0 w-full py-4">
                                                <span className="text-lg text-gray-400 mr-3 inline-flex items-center leading-none pr-3 py-1">
                                                    Giá: {item.gia}
                                                </span>
                                            </div>
                                        </div>
